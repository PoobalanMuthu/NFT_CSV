 ...
 */
public class Test_NFT_S11_see_Any_Aborted_Tests_from_TestHistory extends TestBase {
	@SuppressWarnings("static-access")
	@Test
	public void Test_NFT_S11_see_Any_Aborted_Tests_from_TestHistory_TestCase() throws Exception {
		try {
		/*	String URL = rds.getValue("DATA", currentTest, "URL");
            ...
            String URL = rdss.readCSVFilewitRowName("URL", "S11_see_Any_Aborted_Tests_from_TestHistory-Run1");
            String username = rdss.readCSVFilewitRowName( "UserName", "S11_see_Any_Aborted_Tests_from_TestHistory-Run1");
            String password = rdss.readCSVFilewitRowName( "Password", "S11_see_Any_Aborted_Tests_from_TestHistory-Run1");
			...
			NFTobj.see_any_Aborted_Tests_From_TestHistoryPage();
			NFTobj.logout();
